...
<div class="about-remui-wrapper text-center">
    <div class="about-remui m-auto" style="max-width: 1000px;">
        <h1 class="text-center">Welcome To Educ8 RemUI</h1><br>
        <h5 class="text-muted">
        Educ8 RemUI is the new revolution in Moodle User Experience. It has been suitably designed
        ...
        <img src="' . $CFG->wwwroot . '/theme/remui/pix/screenshot.jpg" class="w-full" alt="Educ8 RemUI screen shot" style="max-width: 100%;"/>
        </div>
        <br><br>
        ...
        <br>
        <div class="text-center">
            <a class="btn btn-primary btn-lg" target="_blank" href="https://Educ8.org/contact-us/">Contact Us</a>&nbsp;&nbsp;
        </div>
    </div>
</div>
<br />';
$string['aboutremui'] = 'About Educ8 RemUI';
$string['currentinparentheses'] = '(current)';
$string['configtitle'] = 'Educ8 RemUI';
$string['fontsize'] = 'Theme base fontsize';
$string['fontsize_desc'] = 'Enter a fontsize in %';
$string['nobootswatch'] = 'None';
$string['pluginname'] = 'Educ8 RemUI';
...
$string['poweredbyeduc8'] = 'Powered by Educ8';
$string['poweredbyeduc8desc'] = 'Uncheck to remove  \'Powered by Educ8\' from your site.';
...
$string['educ8remuilicenseactivation'] = 'Educ8 RemUI License Activation';

// News And Updates Page.
$string['newsandupdates'] = 'News & Updates';
$string['newupdatemessage'] = 'New Update Available for Educ8 plugin. <a class="text-white" href="{$a}"><u>Click here</u></a> to see.';
...
// About Educ8 RemUI.
$string['aboutsettings'] = 'About Educ8 RemUI';
...
$string['poweredby'] = 'Powered by Educ8 RemUI';
...
$string['invalidjsonfile'] = 'Error: Invalid json of Educ8 product list.';
